<template>
    <el-dialog ref="LookupModal" class="dialog-lookup" :title="dialogOptions.title" :modal-append-to-body="false" :width="dialogOptions.width" :fullscreen="dialogOptions.fullscreen" :modal="dialogOptions.modal" :visible.sync="selfVisible" :top="dialogOptions.top" @open="handleOpen" @close="handleClose">
        ...
        <el-pagination class="pagin" @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="fetchOptions.pageIndex" :page-size="fetchOptions.maxResultCount" :page-sizes="[25, 50, 100]" layout="sizes,total, prev, pager, next" :total="fetchOptions.totalCount">
        </el-pagination>
